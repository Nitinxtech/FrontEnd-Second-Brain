...
export function CreateContentModal({open, onClose}) {
    ...
    return <div>
        {open && <div>
            <div className="w-screen h-screen bg-slate-800 fixed top-0 left-0 opacity-70 flex justify-center">
            </div>
            <div className="w-screen h-screen fixed top-0 left-20 flex justify-center">
